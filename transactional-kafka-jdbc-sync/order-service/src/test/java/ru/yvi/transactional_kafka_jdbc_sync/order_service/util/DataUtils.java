...
public class DataUtils {
    ...
    public static final UUID UUID_ORDER_2 = UUID.fromString("06a79143-082a-474d-b1f8-ef8a083edf49");
    ...
    public static OrderEntity getOrderOneTransient() {
        return OrderEntity.builder()
                ...
                .cartEntities(Set.of(
                        CartEntity.builder().itemId(1L).name("Laptop").quantity(1).build(),
                        CartEntity.builder().itemId(2L).name("Desktop").quantity(2).build()
                ))
                .build();
    }
    ...
    public static OrderEntity getOrderOnePersistent() {
        return OrderEntity.builder()
                ...
                .totalAmount(new BigDecimal("239.25").setScale(2, RoundingMode.HALF_UP))
                .createdAt(Instant.parse("2026-02-05T18:17:15.913761500Z"))
                .updatedAt(Instant.parse("2026-02-05T18:17:15.913761500Z"))
                .cartEntities(Set.of(
                        CartEntity.builder().itemId(1L).name("Laptop").quantity(1).build(),
                        CartEntity.builder().itemId(2L).name("Desktop").quantity(2).build()
                ))
    ...
    public static CartEntity getCartItemOneTransient() {
    ...
    public static CartEntity getCartItemTwoTransient() {
        return CartEntity.builder()
                .itemId(2L)
                .name("Desktop")
                .quantity(1)
